        ...
        if (data != null && data.getData() != null && resultCode == RESULT_OK) {
            ...
            if (isKitKat && DocumentsContract.isDocumentUri(form.this, uri)) {
                if ("com.android.externalstorage.documents".equals(uri.getAuthority())) {
                    ...
                    try {
                        cursor = form.this.getContentResolver().query(contentUri, projection, null, null, null);
                    ...
                    try {
                        ...
                        cursor = form.this.getContentResolver().query(contentUri, projection, selection, selectionArgs, null);
                        if (cursor != null && cursor.moveToFirst()) {
                            int column_index = cursor.getColumnIndexOrThrow(column);
                            imgPath = cursor.getString(column_index);
                        }
                ...
                String[] projection = {column};
                try {
                    cursor = form.this.getContentResolver().query(uri, projection, null, null, null);
                    if (cursor != null && cursor.moveToFirst()) {
                        int column_index = cursor.getColumnIndexOrThrow(column);
                        imgPath = cursor.getString(column_index);
                    }
